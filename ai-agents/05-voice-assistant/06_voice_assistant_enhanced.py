"""
06 - Enhanced Voice Assistant with Web Search + RAG
Complete voice assistant with:
- Knowledge Base Search (RAG with Qdrant)
...
class VoiceAssistantEnhanced:
    """
    Enhanced voice assistant with both Knowledge Base and Web Search
    """
    ...
    def __init__(self, whisper_model_size: str = "base", tts_voice_index: int = 0):
        ...
        # Initialize LLM and Agent with BOTH tools
        ...
        print("✅ Enhanced Agent initialized with 2 tools:")
        print("   - Knowledge Base Search (technical docs)")
    ...
    def start(self):
        ...
        try:
            ...
            print("\n\n⏹️  Stopping Enhanced Voice Assistant...")
...
def main():
    """Main function"""
    print("\n🎙️  Enhanced Voice Assistant with RAG + Web Search\n")
    ...
    try:
        ...
        print("   Knowledge Base Search will be unavailable.")
