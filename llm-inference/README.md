...
| **DiffusionGemma 26B-A4B** as a decision engine (Q4) | 17 GB | **534 ms / decision** | Jev-style reads: 89 % SST-2 / 77 % AG News, 0 format errors, 10 answers in 294 ms. Text generation only 14.6 tok/s. |
